...
public class EnderChestInterfaceScreen extends AbstractContainerScreen<EnderChestInterfaceContainer> {
    ...
    public EnderChestInterfaceScreen(EnderChestInterfaceContainer container, Inventory inv, Component name) {
